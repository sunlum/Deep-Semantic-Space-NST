...
def parse_args():
    ...
    parser.add_argument('asem_image_path', metavar='ref', type=str,
                        help='Path to the semlight of style image')
    parser.add_argument('a_image_path', metavar='base', type=str,
                        help='Path to the style image')
    parser.add_argument('bsem_image_path', metavar='ref', type=str,
                        help='Path to the semlight of content image')
    ...
    parser.add_argument('--analogy-w', dest='analogy_weight', type=float,
                        default=5.0, help='Weight for analogy loss.')
    ...
    parser.add_argument('--b-content-w', dest='content_weight', type=float,
                        default=0.05, help='Weight for content loss between B and B\'')
    ...
    parser.add_argument('--nstyle-w', dest='neural_style_weight', type=float,
                        default=100.0, help='Weight for neural style loss between A\' and B\'')
